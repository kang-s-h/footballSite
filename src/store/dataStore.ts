...
import { getTeamImg, getTeamLeagueCup, getTeamSquad, getTeamStatistics, getTeamTransfer } from "../apis/team";
...
export const dataStore = create<Data>((set, get) => ({
  selectedLeagueId: 0,
  selectedTeamId: 0,
  selectedPlayerId: 0,
  nextFixtures: [],
  ...
  fetchTeamData: async () => {
    try {
      ...
      const [
        ...
        getTeamStatistics({ season: 2024, team: selectedTeamId }),
